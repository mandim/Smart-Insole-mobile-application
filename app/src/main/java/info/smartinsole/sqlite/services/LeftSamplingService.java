...
public class LeftSamplingService extends Service {
    ...
    //private String LEFT_DEVICE_ADDR = "10:52:1C:50:B2:EA";
    private String LEFT_DEVICE_ADDR;
    private String defaultAddress = "NO ADDRESS PROVIDED!";
    SharedPreferences sp;

    private final UUID SERVICE_UUID = convertFromInteger(0x1700);
    private final UUID DATA_CHARACTERISTIC_UUID = convertFromInteger(0x1A00);
    private final UUID SETUP_CHARACTERISTIC_UUID = convertFromInteger(0x1A01);
    ...
    public class LocalBinder extends Binder {
        public LeftSamplingService getService() {
            return LeftSamplingService.this;
        }
    }
    ...
    public void onCreate() {
        ...
        sp = getSharedPreferences("LEFT_MAC_ADDRESS", MODE_PRIVATE);
        LEFT_DEVICE_ADDR = sp.getString("leftMac", defaultAddress);
    }
    ...
    private ScanCallback mLeScanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result)
        {
            ...
            if (result.getDevice().getAddress().equals(LEFT_DEVICE_ADDR)) {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            if (deviceMac.equals(LEFT_DEVICE_ADDR)) {
    ...
    public void DataProcessing(String deviceMAC, String measurement) {
        ...
        try {
            if (measurement.equals("No valid timestamp received")) {
                ...
                Log.d("characteristic Device1 READ", "("+incomecount+") Data income");
            }
    ...
    private Sole GetMeasurementObj(String deviceMAC, String measurement) throws JSONException, ParseException {
        ...
        return new Sole(0, deviceMAC, userId, date, "LEFT", "0",
