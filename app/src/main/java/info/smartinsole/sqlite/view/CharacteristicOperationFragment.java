...
public class CharacteristicOperationFragment extends Fragment {
    ...
    public void showData() {
        final BleDevice bleDevice = ((TestScanBleActivity) getActivity()).getBleDevice();
        final BluetoothGattCharacteristic characteristic = ((TestScanBleActivity) getActivity()).getCharacteristic();
        final int charaProp = ((TestScanBleActivity) getActivity()).getCharaProp();
                                        ...
                                        public void onReadSuccess(final byte[] data) {
                                            runOnUiThread(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    String test =HexUtil.formatHexString(data, true);
                    ...
                    btn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            BleManager.getInstance().write(
                                    ...
                                    characteristic.getService().getUuid().toString(),
                                    characteristic.getUuid().toString(),
                                    HexUtil.hexStringToBytes(timestamp),
                                            ...
                                            public void onCharacteristicChanged(byte[] data) {
                                                runOnUiThread(new Runnable() {
                                                    ...
                                                    public void run() {
                                                        ...
                                                        String test = HexUtil.formatHexString(characteristic.getValue(), true);
                                                        String s = new String(data, StandardCharsets.UTF_8);
